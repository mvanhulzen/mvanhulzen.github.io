define(["lib-build/css!./MapCommand",
	...
	function(viewCss, has, Point, on, PictureMarkerSymbol, GraphicsLayer, Graphic, esriConfig,LocateButton)
	{
		/**
		 * MapCommand
		 * @class MapCommand
		...
		return function MapCommand(map, homeClickCallback, locationButtonCallback, locationButtonEnabled)
		{
			...
			if( navigator && navigator.geolocation ) {
				...
				$(".esriSimpleSlider", map.container).after('<div class="esriSimpleSlider esriSimpleSliderVertical locateButtonContainer"><div id="locateButton"></div></div>');
