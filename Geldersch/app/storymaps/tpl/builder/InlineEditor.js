	...
	function(
		...
		return function InlineEditor()
		{
			...
			this.init = function(container, options)
			{
				...
				/*EsriNL MVH: 20160309: Source added*/ 
				options = options || {
					...
					/*EsriNL MVH: 20160309: input audio and source added*/
					extraAllowedContent: 'h1 h2 h3 h4 h5 h6 sub sup table tr th td input audio caption div span source img figure figcaption iframe; *(*); *[*]; a[data-*]',
